...
<form name='gjb_registre' action='{$url}' method='post'>
	...
	<table class='gjb_table'><tbody>
		<tr>
			...
			<td><input type='text' name='gjb_nom' id='gjb_nom' maxlength='50' size='20' style='width:200px;' value='{$current_user->user_firstname}'></td>
		</tr>
		<tr>
			<td><label for='gjb_cognoms'>{$lang['REG_SURNAME']}:</label></td>
			<td><input type='text' name='gjb_cognoms' id='gjb_cognoms' maxlength='100' size='20' style='width:200px;' value='{$current_user->user_lastname}'></td>
		</tr>
		<tr>
			<td><label for='gjb_dniselect'>{$lang['REG_ID_TYPE']}:</label></td>
			<td>
				<select name='gjb_dniselect' id='gjb_dniselect' style='width:205px;'>
		...
		<tr>
			...
			<td><input type='text' name='gjb_dni' id='gjb_dni' style='width:200px;' size='20'></td>
		</tr>
		<tr>
			<td><label for='gjb_email'>{$lang['REG_EMAIL']}:</label></td>
			<td><input type='text' name='gjb_email' id='gjb_email' style='width:200px;' maxlength='50' size='20' value='{$current_user->user_email}'></td>
		</tr>
	</tbody></table>
	<p>{$lang['REG_TEXT2']}</p>
	<table class='gjb_table'> <tbody>
